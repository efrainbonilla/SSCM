...
(function($) {
    ...
    defaults = {
        ...
        inputs: {
            ...
            paginationClass: 'dynatable-pagination-links pagination pagination-sm',
            paginationLinkClass: 'dynatable-page-link',
            paginationPrevClass: 'dynatable-page-prev',
            paginationNextClass: 'dynatable-page-next',
            paginationActiveClass: 'dynatable-active-page active',
    ...
    function InputsSearch(obj, settings) {
        ...
        this.create = function() {
            ...
            $searchContent = $('<div></div>', {
                id: 'dynatable-search-' + obj.element.id,
                'class': 'dynatable-search input-group input-group-sm',
                'style': 'width:400px;'
            }).append($search).append($searchSpan);
