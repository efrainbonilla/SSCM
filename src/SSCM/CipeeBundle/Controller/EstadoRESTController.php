...
use SSCM\CipeeBundle\Entity\Estado;
use SSCM\CipeeBundle\Form\EstadoType;
...
class EstadoRESTController extends VoryxController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $entities = $em->getRepository('CipeeBundle:Estado', 'db_cipee')->findBy($filters, $order_by, $limit, $offset);
            if ($entities) {
                return $entities;
            }
