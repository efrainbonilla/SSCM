...
/**
 * EstadoAcademico controller.
 * @RouteResource("EstadoAcademico")
 */
class EstadoAcademico2RESTController extends VoryxController
{
    /**
     ...
     *
     */
    public function getAction($ceduAlmn, $id)
    {
        /*return array('data' => array('cedu' => $ceduAlmn, 'id' => $id));*/
        $entity = $this->getEntity($ceduAlmn, $id);
        if ($entity) {
            return $entity[0];
        }
    ...
    /**
     * Partial Update to a EstadoAcademico entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
    ...
    */
     ...
     * @return Alumno
     */
    protected function getEntity($ceduAlmn, $id)
    {
        $em = $this->getDoctrine()->getManager();

        $entity = $em->getRepository('CipeeBundle:EstadoAcademico')
            ->findBy(
                array(
                    'almn' => $ceduAlmn,
                    'id' => $id
